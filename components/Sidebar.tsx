...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate, theme, onThemeToggle, onLogout, currentUser }) => {
  ...
  return (
    <>
      ...
      <aside className={`hidden md:flex flex-shrink-0 flex-col h-full border-r border-gray-200/10 bg-white/[0.04] dark:bg-zinc-950/25 backdrop-blur-2xl bleed-glass transition-all duration-300 relative border-t-white/10 dark:border-t-white/5 shadow-[0_8px_32px_0_rgba(0,0,0,0.15)] ${isCollapsed ? 'w-24' : 'w-72'}`}>
